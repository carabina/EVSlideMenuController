...
+ (instancetype)slideMenuControllerWithMenuArray:(NSArray *)menuArray
    ...
    EVSlideMenuController *EVSlideMenuController = [[self alloc] init];
    EVSlideMenuController.menuWidth = menuWidth?:kSlideMenuControllerMenuButtonWidth;
    EVSlideMenuController.normalColor = normalColor?:[UIColor grayColor];
    EVSlideMenuController.selectColor = selectColor?:[UIColor redColor];
    [EVSlideMenuController setMenuArray:menuArray];
    [EVSlideMenuController menuBgView]; //显示menu背景视图
    EVSlideMenuController.scrollsToTop = YES;
    return EVSlideMenuController;
}
